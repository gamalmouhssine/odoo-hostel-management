...
""",
    ...
    'images': [
        ...
        'static/description/screenshot_booking_form.png',
        'static/description/screenshot_rooms_kanban.png',
        'static/description/screenshot_beds.png',
        'static/description/screenshot_folios_list.png',
        'static/description/screenshot_folio.png',
        'static/description/screenshot_housekeeping.png',
        'static/description/screenshot_guests.png',
    ],
    'installable': True,
    'application': True,
    'auto_install': False,
